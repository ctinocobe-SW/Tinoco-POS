        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Transferencias de bodega a El Mercader. Confirma la lista y márcala en tránsito; el checador verifica la recepción.
            </p>
          </div>
        </div>
        <ListasSurtidoGestionSection listas={listasSurtidoData} rol="despachador" />
      </div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Usa el botón "Borrador automático" para generar una lista de surtido inteligente.
            </p>
          </div>
        </div>
        <ListasAlmacenSection listas={listasAlmacenData} rol="despachador" />
      </div>
    </div>
  )
}
